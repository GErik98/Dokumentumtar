...
function validalas(){
    ...
    else if (!password.value.match(passwordReg))
    {
      ...
      window.localStorage.setItem('lsEmail', emailaddress.value);
      window.localStorage.setItem('lsUsername', username.value);
      window.localStorage.setItem('lsPassword', password.value);
